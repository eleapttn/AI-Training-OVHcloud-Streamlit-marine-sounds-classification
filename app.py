...
def transform_wav_to_csv():
    ...
    csv_file = open('data/test.csv', 'w', newline = '')
    with csv_file:
        writer = csv.writer(csv_file)
        writer.writerow(header_test)
    
    # transform each .wav file into a .csv row using Librosa parameters
    for filename in os.listdir('data/test_audios/'):
        sound = f'data/test_audios/{filename}'
        ...
        csv_file = open('data/test.csv', 'a', newline = '')
        with csv_file:
            writer = csv.writer(csv_file)
